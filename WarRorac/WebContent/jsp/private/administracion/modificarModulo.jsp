...
<script src="${pageContext.servletContext.contextPath}/recursos/javascript/administracion/modificarModulo.js" type="text/javascript"></script>
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="3"><input name="nombreModulo"
							type="text" class="Campos_Des" maxlength="80" id="nombreModulo" value="<c:out value="${modulo.nombreModulo}"/>"/></td><div style="color:#FF0000;" id="nombreRequerido">${divIngresarNombre}</div>
					</tr>
					<tr>
						<td class="odd">${descripcionModulo}:</td>
						<td colspan="3"><textarea rows="4" cols="50" id="descripcionModulo" name="descripcionModulo"><c:out value="${modulo.descripcionModulo}"/></textarea>(300 caracteres m&aacute;ximo)</td><div style="color:#FF0000;" id="descripcionRequerido">${divIngresarDescripcion}</div>
					</tr>
				</tbody>
			</table>
