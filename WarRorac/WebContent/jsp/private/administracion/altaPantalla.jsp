...
<script src="${pageContext.servletContext.contextPath}/recursos/javascript/administracion/altaPantalla.js" type="text/javascript"></script>
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="3"><input name="nombrePantalla"
							type="text" class="Campos_Des" id="nombrePantalla" maxlength="80"/></td><div style="color:#FF0000;" id="nombreRequerido">${divIngresarNombre}</div>
					</tr>
					<tr>
