...
public class BOMonitorMotorImpl extends Architech implements BOMonitorMotor {
	...
	public BeanMonitorMotor obtenerEstatusMotor(
		...
		try {
			...
			monitorMotor.setInsumosMotorRorac(extraeConfigsFromList(
					estatusInsumosMotor, INSUMOS_MOTOR));
			monitorMotor.setInsumosCorporativos(extraeConfigsFromList(
					estatusInsumosMotor, INSUMOS_CORPORATIVOS));
			monitorMotor.setLanzamientoMotorRorac(extraeConfigsFromList(
					estatusInsumosMotor, LANZA_MOTOR));
