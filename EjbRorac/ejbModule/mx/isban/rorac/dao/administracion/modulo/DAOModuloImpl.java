...
public class DAOModuloImpl extends Architech implements DAOModulo {
	 ...
	 */
	@Override
	public BeanModuloRespuesta obtenerModulosPorGrupos(final ArchitechSessionBean sessionBean, final String[] grupos) {
		this.info("Se inicia la consulta del perfil con la lista de grupos: "+ grupos);
		...
		requestDTO.setQuery(QUERY_MODULOS_POR_GRUPOS + QueryAppenderUtil.buildInParameterFromList(grupos));
