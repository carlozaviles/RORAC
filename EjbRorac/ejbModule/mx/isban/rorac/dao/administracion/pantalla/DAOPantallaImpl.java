...
public class DAOPantallaImpl extends Architech implements DAOPantalla {
	 ...
	 */
	@Override
	public BeanPantallaRespuesta obtenerPantallasPorGruposModulo(final ArchitechSessionBean sessionBean, final String idModulo, final String[] grupos) {
		...
		requestDTO.setQuery(QUERY_OBTIENE_PANTALLA_GRUPO_MODULO+ QueryAppenderUtil.buildInParameterFromList(grupos));
		requestDTO.setCodeOperation("COD010 Consulta-Pantallas por ID");
		requestDTO.addParamToSql(idModulo);
